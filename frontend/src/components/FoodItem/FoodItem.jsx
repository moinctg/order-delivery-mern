    ...
    return (
        <div className='food-item'>
            <div className="food-item-img-container">
                {/* Dynamically set image URL from Cloudinary */}
                {/* Assuming `image` contains the public ID for Cloudinary */}
                <img className='food-item-image' 
                     src={`https://res.cloudinary.com/dsx5abzif/image/upload/v${image}`} 
                     alt={name} />
